...
mixin _$IpInfo {
 ...
 String get ip; String get countryCode; double? get latitude; double? get longitude;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IpInfo&&(identical(other.ip, ip) || other.ip == ip)&&(identical(other.countryCode, countryCode) || other.countryCode == countryCode)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude));
}


@override
int get hashCode => Object.hash(runtimeType,ip,countryCode,latitude,longitude);

@override
String toString() {
  return 'IpInfo(ip: $ip, countryCode: $countryCode, latitude: $latitude, longitude: $longitude)';
}
...
@useResult
$Res call({
 String ip, String countryCode, double? latitude, double? longitude
});
...
/// Create a copy of IpInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? ip = null,Object? countryCode = null,Object? latitude = freezed,Object? longitude = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String ip,  String countryCode,  double? latitude,  double? longitude)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IpInfo() when $default != null:
return $default(_that.ip,_that.countryCode,_that.latitude,_that.longitude);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String ip,  String countryCode,  double? latitude,  double? longitude)  $default,) {final _that = this;
switch (_that) {
case _IpInfo():
return $default(_that.ip,_that.countryCode,_that.latitude,_that.longitude);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String ip,  String countryCode,  double? latitude,  double? longitude)?  $default,) {final _that = this;
switch (_that) {
case _IpInfo() when $default != null:
return $default(_that.ip,_that.countryCode,_that.latitude,_that.longitude);case _:
  return null;
...
class _IpInfo implements IpInfo {
  const _IpInfo({required this.ip, required this.countryCode, this.latitude, this.longitude});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IpInfo&&(identical(other.ip, ip) || other.ip == ip)&&(identical(other.countryCode, countryCode) || other.countryCode == countryCode)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude));
}
...
/// Create a copy of IpInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? ip = null,Object? countryCode = null,Object? latitude = freezed,Object? longitude = freezed,}) {
