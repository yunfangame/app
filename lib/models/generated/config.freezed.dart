...
mixin _$AppSettingProps {
 ...
 String? get locale;@JsonKey(fromJson: dashboardWidgetsSafeFormJson) List<DashboardWidget> get dashboardWidgets; bool get onlyStatisticsProxy; bool get autoLaunch; bool get silentLaunch; bool get autoRun; bool get openLogs; bool get closeConnections; String get testUrl; bool get isAnimateToPage; bool get autoCheckUpdate; bool get showLabel; bool get crashlyticsTip; bool get crashlytics; bool get minimizeOnExit; bool get hidden; bool get developerMode; bool get campusNetworkEnabled; String get campusOperator; Map<String, Map<String, String>> get campusHostsByOperator; List<ChainProxyConfig> get chainProxies; String? get activeChainProxyName; RestoreStrategy get restoreStrategy; bool get showTrayTitle; String get customUserAgent; bool get skipGlobalModeConfirmation;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,locale,const DeepCollectionEquality().hash(dashboardWidgets),onlyStatisticsProxy,autoLaunch,silentLaunch,autoRun,openLogs,closeConnections,testUrl,isAnimateToPage,autoCheckUpdate,showLabel,crashlyticsTip,crashlytics,minimizeOnExit,hidden,developerMode,campusNetworkEnabled,campusOperator,const DeepCollectionEquality().hash(campusHostsByOperator),const DeepCollectionEquality().hash(chainProxies),activeChainProxyName,restoreStrategy,showTrayTitle,customUserAgent,skipGlobalModeConfirmation]);

@override
String toString() {
  return 'AppSettingProps(locale: $locale, dashboardWidgets: $dashboardWidgets, onlyStatisticsProxy: $onlyStatisticsProxy, autoLaunch: $autoLaunch, silentLaunch: $silentLaunch, autoRun: $autoRun, openLogs: $openLogs, closeConnections: $closeConnections, testUrl: $testUrl, isAnimateToPage: $isAnimateToPage, autoCheckUpdate: $autoCheckUpdate, showLabel: $showLabel, crashlyticsTip: $crashlyticsTip, crashlytics: $crashlytics, minimizeOnExit: $minimizeOnExit, hidden: $hidden, developerMode: $developerMode, campusNetworkEnabled: $campusNetworkEnabled, campusOperator: $campusOperator, campusHostsByOperator: $campusHostsByOperator, chainProxies: $chainProxies, activeChainProxyName: $activeChainProxyName, restoreStrategy: $restoreStrategy, showTrayTitle: $showTrayTitle, customUserAgent: $customUserAgent, skipGlobalModeConfirmation: $skipGlobalModeConfirmation)';
}
...
@useResult
$Res call({
 String? locale,@JsonKey(fromJson: dashboardWidgetsSafeFormJson) List<DashboardWidget> dashboardWidgets, bool onlyStatisticsProxy, bool autoLaunch, bool silentLaunch, bool autoRun, bool openLogs, bool closeConnections, String testUrl, bool isAnimateToPage, bool autoCheckUpdate, bool showLabel, bool crashlyticsTip, bool crashlytics, bool minimizeOnExit, bool hidden, bool developerMode, bool campusNetworkEnabled, String campusOperator, Map<String, Map<String, String>> campusHostsByOperator, List<ChainProxyConfig> chainProxies, String? activeChainProxyName, RestoreStrategy restoreStrategy, bool showTrayTitle, String customUserAgent, bool skipGlobalModeConfirmation
});
...
as String,campusHostsByOperator: null == campusHostsByOperator ? _self.campusHostsByOperator : campusHostsByOperator // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _AppSettingProps() when $default != null:
return $default(_that.locale,_that.dashboardWidgets,_that.onlyStatisticsProxy,_that.autoLaunch,_that.silentLaunch,_that.autoRun,_that.openLogs,_that.closeConnections,_that.testUrl,_that.isAnimateToPage,_that.autoCheckUpdate,_that.showLabel,_that.crashlyticsTip,_that.crashlytics,_that.minimizeOnExit,_that.hidden,_that.developerMode,_that.campusNetworkEnabled,_that.campusOperator,_that.campusHostsByOperator,_that.chainProxies,_that.activeChainProxyName,_that.restoreStrategy,_that.showTrayTitle,_that.customUserAgent,_that.skipGlobalModeConfirmation);case _:
  return orElse();
...
class _AppSettingProps implements AppSettingProps {
  const _AppSettingProps({this.locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson) final  List<DashboardWidget> dashboardWidgets = defaultDashboardWidgets, this.onlyStatisticsProxy = false, this.autoLaunch = false, this.silentLaunch = false, this.autoRun = false, this.openLogs = false, this.closeConnections = false, this.testUrl = defaultTestUrl, this.isAnimateToPage = true, this.autoCheckUpdate = true, this.showLabel = false, this.crashlyticsTip = false, this.crashlytics = false, this.minimizeOnExit = true, this.hidden = false, this.developerMode = false, this.campusNetworkEnabled = false, this.campusOperator = 'telecom', final  Map<String, Map<String, String>> campusHostsByOperator = const {}, final  List<ChainProxyConfig> chainProxies = const [], this.activeChainProxyName, this.restoreStrategy = RestoreStrategy.compatible, this.showTrayTitle = true, this.customUserAgent = '', this.skipGlobalModeConfirmation = false}): _dashboardWidgets = dashboardWidgets,_campusHostsByOperator = campusHostsByOperator,_chainProxies = chainProxies;
...
@override@JsonKey() final  bool campusNetworkEnabled;
@override@JsonKey() final  String campusOperator;
 final  Map<String, Map<String, String>> _campusHostsByOperator;
@override@JsonKey() Map<String, Map<String, String>> get campusHostsByOperator {
  if (_campusHostsByOperator is EqualUnmodifiableMapView) return _campusHostsByOperator;
  // ignore: implicit_dynamic_type
...
@override@JsonKey() final  bool skipGlobalModeConfirmation;
...
as bool,campusNetworkEnabled: null == campusNetworkEnabled ? _self.campusNetworkEnabled : campusNetworkEnabled // ignore: cast_nullable_to_non_nullable
as bool,campusOperator: null == campusOperator ? _self.campusOperator : campusOperator // ignore: cast_nullable_to_non_nullable
as String,campusHostsByOperator: null == campusHostsByOperator ? _self._campusHostsByOperator : campusHostsByOperator // ignore: cast_nullable_to_non_nullable
...
mixin _$AccessControlProps {
 ...
 bool get enable; AccessControlMode get mode; List<String> get acceptList; List<String> get rejectList; AccessSortType get sort; bool get isFilterSystemApp; bool get isFilterNonInternetApp; bool get isFilterNonLaunchableApp;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AccessControlProps&&(identical(other.enable, enable) || other.enable == enable)&&(identical(other.mode, mode) || other.mode == mode)&&const DeepCollectionEquality().equals(other.acceptList, acceptList)&&const DeepCollectionEquality().equals(other.rejectList, rejectList)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.isFilterSystemApp, isFilterSystemApp) || other.isFilterSystemApp == isFilterSystemApp)&&(identical(other.isFilterNonInternetApp, isFilterNonInternetApp) || other.isFilterNonInternetApp == isFilterNonInternetApp)&&(identical(other.isFilterNonLaunchableApp, isFilterNonLaunchableApp) || other.isFilterNonLaunchableApp == isFilterNonLaunchableApp));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,enable,mode,const DeepCollectionEquality().hash(acceptList),const DeepCollectionEquality().hash(rejectList),sort,isFilterSystemApp,isFilterNonInternetApp,isFilterNonLaunchableApp);

@override
String toString() {
  return 'AccessControlProps(enable: $enable, mode: $mode, acceptList: $acceptList, rejectList: $rejectList, sort: $sort, isFilterSystemApp: $isFilterSystemApp, isFilterNonInternetApp: $isFilterNonInternetApp, isFilterNonLaunchableApp: $isFilterNonLaunchableApp)';
}
...
@useResult
$Res call({
 bool enable, AccessControlMode mode, List<String> acceptList, List<String> rejectList, AccessSortType sort, bool isFilterSystemApp, bool isFilterNonInternetApp, bool isFilterNonLaunchableApp
});
...
/// Create a copy of AccessControlProps
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? enable = null,Object? mode = null,Object? acceptList = null,Object? rejectList = null,Object? sort = null,Object? isFilterSystemApp = null,Object? isFilterNonInternetApp = null,Object? isFilterNonLaunchableApp = null,}) {
  return _then(_self.copyWith(
...
as bool,isFilterNonLaunchableApp: null == isFilterNonLaunchableApp ? _self.isFilterNonLaunchableApp : isFilterNonLaunchableApp // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool enable,  AccessControlMode mode,  List<String> acceptList,  List<String> rejectList,  AccessSortType sort,  bool isFilterSystemApp,  bool isFilterNonInternetApp,  bool isFilterNonLaunchableApp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccessControlProps() when $default != null:
return $default(_that.enable,_that.mode,_that.acceptList,_that.rejectList,_that.sort,_that.isFilterSystemApp,_that.isFilterNonInternetApp,_that.isFilterNonLaunchableApp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool enable,  AccessControlMode mode,  List<String> acceptList,  List<String> rejectList,  AccessSortType sort,  bool isFilterSystemApp,  bool isFilterNonInternetApp,  bool isFilterNonLaunchableApp)  $default,) {final _that = this;
switch (_that) {
case _AccessControlProps():
return $default(_that.enable,_that.mode,_that.acceptList,_that.rejectList,_that.sort,_that.isFilterSystemApp,_that.isFilterNonInternetApp,_that.isFilterNonLaunchableApp);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool enable,  AccessControlMode mode,  List<String> acceptList,  List<String> rejectList,  AccessSortType sort,  bool isFilterSystemApp,  bool isFilterNonInternetApp,  bool isFilterNonLaunchableApp)?  $default,) {final _that = this;
switch (_that) {
case _AccessControlProps() when $default != null:
return $default(_that.enable,_that.mode,_that.acceptList,_that.rejectList,_that.sort,_that.isFilterSystemApp,_that.isFilterNonInternetApp,_that.isFilterNonLaunchableApp);case _:
  return null;
...
class _AccessControlProps implements AccessControlProps {
  const _AccessControlProps({this.enable = false, this.mode = AccessControlMode.rejectSelected, final  List<String> acceptList = const [], final  List<String> rejectList = const [], this.sort = AccessSortType.none, this.isFilterSystemApp = true, this.isFilterNonInternetApp = true, this.isFilterNonLaunchableApp = true}): _acceptList = acceptList,_rejectList = rejectList;
...
@override@JsonKey() final  bool isFilterNonLaunchableApp;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,enable,mode,const DeepCollectionEquality().hash(_acceptList),const DeepCollectionEquality().hash(_rejectList),sort,isFilterSystemApp,isFilterNonInternetApp,isFilterNonLaunchableApp);
...
/// Create a copy of AccessControlProps
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? enable = null,Object? mode = null,Object? acceptList = null,Object? rejectList = null,Object? sort = null,Object? isFilterSystemApp = null,Object? isFilterNonInternetApp = null,Object? isFilterNonLaunchableApp = null,}) {
