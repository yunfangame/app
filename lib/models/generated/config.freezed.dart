...
class _AppSettingProps implements AppSettingProps {
  const _AppSettingProps({this.locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson) final  List<DashboardWidget> dashboardWidgets = defaultDashboardWidgets, this.onlyStatisticsProxy = false, this.autoLaunch = false, this.silentLaunch = false, this.autoRun = false, this.openLogs = false, this.closeConnections = false, this.testUrl = defaultTestUrl, this.isAnimateToPage = true, this.autoCheckUpdate = true, this.showLabel = false, this.disclaimerAccepted = false, this.crashlyticsTip = false, this.crashlytics = false, this.minimizeOnExit = true, this.hidden = false, this.developerMode = false, this.campusNetworkEnabled = false, this.campusOperator = CampusOperator.telecom, final  Map<String, Map<String, String>> campusHostsByOperator = const {}, final  List<ChainProxyConfig> chainProxies = const [], this.activeChainProxyName, this.restoreStrategy = RestoreStrategy.compatible, this.showTrayTitle = true, this.customUserAgent = '', this.skipGlobalModeConfirmation = false}): _dashboardWidgets = dashboardWidgets,_campusHostsByOperator = campusHostsByOperator,_chainProxies = chainProxies;
...
@override@JsonKey() final  CampusOperator campusOperator;
