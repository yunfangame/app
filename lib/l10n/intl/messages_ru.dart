...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(status) =>
      "API вернул HTTP ${status}. Повторите попытку позже или экспортируйте журнал для поддержки.";

  static String m4(status) =>
      "Сервер или промежуточный прокси отклонил доступ (HTTP ${status}). Это не доказывает, что пароль неверен.";

  static String m5(version) => "Доступна версия ${version}";

  static String m6(version) => "Текущая версия ${version}";

  static String m7(version) => "Версия ${version} является последней";

  static String m8(received, total) => "${received} / ${total}";

  static String m9(current, latest) => "Текущая ${current}  →  Новая ${latest}";

  static String m10(index) => "Маршрут ${index}";

  static String m11(count) => "Стран и регионов: ${count}";
  ...
  static String m15(port) => "Текущий порт: ${port}";

  static String m16(code) => "Код ошибки: ${code}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "apiFailureCancelled": MessageLookupByLibrary.simpleMessage(
      "Запрос API отменён. Можно повторить попытку.",
    ),
    "apiFailureConfiguration": MessageLookupByLibrary.simpleMessage(
      "Конфигурация API отсутствует или неверна. Обновите её или обратитесь в поддержку.",
    ),
    "apiFailureDecrypt": MessageLookupByLibrary.simpleMessage(
      "Не удалось расшифровать удалённую конфигурацию. Обновите её или обратитесь в поддержку.",
    ),
    "apiFailureDns": MessageLookupByLibrary.simpleMessage(
      "Не удалось разрешить имя API. Проверьте сеть и настройки DNS.",
    ),
    "apiFailureHelp": MessageLookupByLibrary.simpleMessage(
      "Повторите попытку, проверьте разрешения на доступ к сети или экспортируйте журнал для поддержки. Эта ошибка сама по себе не доказывает блокировку брандмауэром или антивирусом. Не отключайте защиту.",
    ),
    "apiFailureHttp": m3,
    "apiFailureHttpDenied": m4,
    "apiFailureNetwork": MessageLookupByLibrary.simpleMessage(
      "Не удалось подключиться к API. Запустите диагностику API и экспортируйте журнал для анализа.",
    ),
    "apiFailureNoEndpoints": MessageLookupByLibrary.simpleMessage(
      "В конфигурации нет доступных адресов API. Обновите её или обратитесь в поддержку.",
    ),
    "apiFailurePermission": MessageLookupByLibrary.simpleMessage(
      "Доступ к сети запрещён. Возможны ограничения системы или защиты, но конкретное ПО не определено.",
    ),
    "apiFailureRateLimited": MessageLookupByLibrary.simpleMessage(
      "Слишком много запросов API (HTTP 429). Подождите и повторите попытку.",
    ),
    "apiFailureRefused": MessageLookupByLibrary.simpleMessage(
      "Соединение с API отклонено. Возможно, его отклоняет целевой сервис или сетевая политика.",
    ),
    "apiFailureReset": MessageLookupByLibrary.simpleMessage(
      "Соединение с API прервано или сброшено. Повторите попытку или сравните результат в другой сети.",
    ),
    "apiFailureSignature": MessageLookupByLibrary.simpleMessage(
      "Проверка удалённой конфигурации не пройдена. Недоверенная конфигурация не использована. Обратитесь в поддержку.",
    ),
    "apiFailureTimeout": MessageLookupByLibrary.simpleMessage(
      "Время ожидания API истекло. Возможно, сеть или сервис недоступны; блокировка не подтверждена.",
    ),
    "apiFailureTls": MessageLookupByLibrary.simpleMessage(
      "Не удалось проверить защищённое соединение. Проверьте системное время, сертификаты и настройки сети. Не отключайте проверку сертификатов.",
    ),
    ...
    "appUpdateBackground": MessageLookupByLibrary.simpleMessage(
      "Скачать в фоне",
    ),
    "appUpdateCancelDownload": MessageLookupByLibrary.simpleMessage(
      "Отменить загрузку",
    ),
    "appUpdateChecking": MessageLookupByLibrary.simpleMessage(
      "Проверка обновлений…",
    ),
    "appUpdateChecksumMismatch": MessageLookupByLibrary.simpleMessage(
      "Загруженный файл не прошёл проверку. Скачайте его заново.",
    ),
    "appUpdateChecksumMissing": MessageLookupByLibrary.simpleMessage(
      "У обновления нет данных для проверки файла. Загрузка недоступна. Обратитесь в поддержку.",
    ),
    "appUpdateCurrentVersion": m6,
    "appUpdateDownload": MessageLookupByLibrary.simpleMessage(
      "Скачать обновление",
    ),
    "appUpdateDownloadCancelled": MessageLookupByLibrary.simpleMessage(
      "Загрузка отменена",
    ),
    "appUpdateDownloadDetails": MessageLookupByLibrary.simpleMessage(
      "Сведения о загрузке",
    ),
    ...
    "appUpdateDownloadReady": MessageLookupByLibrary.simpleMessage(
      "Загрузка и проверка завершены. Обновление готово к установке.",
    ),
    "appUpdateDownloading": MessageLookupByLibrary.simpleMessage(
      "Загрузка обновления…",
    ),
    "appUpdateFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось проверить обновления. Повторите попытку позже.",
    ),
    "appUpdateIgnoreVersion": MessageLookupByLibrary.simpleMessage(
      "Пропустить эту версию",
    ),
    "appUpdateInstall": MessageLookupByLibrary.simpleMessage(
    ...
    "appUpdateInstallerOpened": MessageLookupByLibrary.simpleMessage(
      "Установщик открыт. Следуйте его инструкциям, чтобы завершить обновление.",
    ),
    "appUpdateInstalling": MessageLookupByLibrary.simpleMessage(
      "Открытие установщика…",
    ),
    "appUpdateLater": MessageLookupByLibrary.simpleMessage("Напомнить позже"),
    "appUpdateLatest": m7,
    "appUpdateOpenFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось открыть ссылку для скачивания. Повторите попытку позже.",
    ),
    "appUpdateProgress": m8,
    "appUpdateRetry": MessageLookupByLibrary.simpleMessage("Повторить"),
    "appUpdateUnavailable": MessageLookupByLibrary.simpleMessage(
      "Информация об обновлении для этой платформы временно недоступна. Повторите попытку позже.",
    ),
    "appUpdateUnsupportedPackage": MessageLookupByLibrary.simpleMessage(
      "Этот пакет обновления не поддерживает установку из приложения.",
    ),
    "appUpdateVerifying": MessageLookupByLibrary.simpleMessage(
    ...
    "blockLoginIp": MessageLookupByLibrary.simpleMessage("Заблокировать"),
    "blockLoginIpTitle": MessageLookupByLibrary.simpleMessage(
      "Заблокировать этот IP входа?",
    ),
    "blockLoginIpWarning": MessageLookupByLibrary.simpleMessage(
      "С этого IP больше нельзя будет войти в аккаунт, но активные сеансы не будут завершены. В общей сети это может затронуть и другие ваши устройства.",
    ),
    "blockReasonHint": MessageLookupByLibrary.simpleMessage(
      "Например: это был не я",
    ),
    "blockReasonOptional": MessageLookupByLibrary.simpleMessage(
      "Причина (необязательно)",
    ),
    "blockedIpCount": MessageLookupByLibrary.simpleMessage("Заблокировано"),
    ...
    "confirmBlockLoginIp": MessageLookupByLibrary.simpleMessage(
      "Заблокировать IP",
    ),
    ...
    "confirmUnblockLoginIp": MessageLookupByLibrary.simpleMessage(
      "Разблокировать IP",
    ),
    ...
    "desktopProxyAddressInUse": MessageLookupByLibrary.simpleMessage(
      "Порт прослушивания занят другой программой. Закройте её и повторите попытку или выберите другой порт.",
    ),
    "desktopProxyAddressNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Заданный адрес прослушивания недоступен на этом компьютере. Проверьте сетевое подключение и адрес привязки, затем повторите попытку.",
    ),
    "desktopProxyChangePort": MessageLookupByLibrary.simpleMessage(
      "Изменить порт",
    ),
    "desktopProxyConfigurationFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось применить конфигурацию прокси. Проверьте текущую подписку и настройки или экспортируйте журналы для выяснения причины.",
    ),
    "desktopProxyCurrentPort": m15,
    "desktopProxyFailureCode": m16,
    "desktopProxyFailureLogs": MessageLookupByLibrary.simpleMessage(
      "Просмотр/экспорт журналов",
    ),
    "desktopProxyFailureLogsHint": MessageLookupByLibrary.simpleMessage(
      "Просмотрите или экспортируйте журналы и передайте сведения об ошибке в поддержку.",
    ),
    "desktopProxyFailureTitle": MessageLookupByLibrary.simpleMessage(
      "Не удалось запустить прокси",
    ),
    "desktopProxyInvalidBindAddress": MessageLookupByLibrary.simpleMessage(
      "Неверный адрес прослушивания. Проверьте адрес привязки в настройках прокси и повторите попытку.",
    ),
    "desktopProxyListenerAccessDenied": MessageLookupByLibrary.simpleMessage(
      "Система запретила доступ к порту прослушивания. Возможно, порт зарезервирован или действует политика безопасности. Проверьте ограничения или попробуйте другой порт.",
    ),
    "desktopProxyLocalPortUnavailable": MessageLookupByLibrary.simpleMessage(
      "Клиент не смог подключиться к локальному порту прокси. Конфликт портов пока не подтверждён. Повторите попытку или экспортируйте журналы; также можно попробовать другой порт.",
    ),
    "desktopProxyPortHint": MessageLookupByLibrary.simpleMessage(
      "Введите новый порт от 1024 до 49151, не используемый другими локальными службами. После сохранения подключение будет повторено.",
    ),
    "desktopProxyPortRange": MessageLookupByLibrary.simpleMessage(
      "Введите целый номер порта от 1024 до 49151",
    ),
    "desktopProxyPortReserved": MessageLookupByLibrary.simpleMessage(
      "Этот порт назначен другой локальной службе. Выберите другой порт",
    ),
    "desktopProxyPortSaveRetry": MessageLookupByLibrary.simpleMessage(
      "Сохранить и повторить",
    ),
    "desktopProxyPortUnchanged": MessageLookupByLibrary.simpleMessage(
      "Выберите порт, отличный от текущего",
    ),
    "desktopProxySystemAccessDenied": MessageLookupByLibrary.simpleMessage(
      "Система запретила изменение настроек прокси. Проверьте права пользователя или политики управления и повторите попытку.",
    ),
    "desktopProxySystemFailed": MessageLookupByLibrary.simpleMessage(
      "Настройка системного прокси не завершена. Повторите попытку; если ошибка повторится, экспортируйте журналы.",
    ),
    "desktopProxySystemFailureTitle": MessageLookupByLibrary.simpleMessage(
      "Не удалось настроить системный прокси",
    ),
    "desktopProxySystemReadbackFailed": MessageLookupByLibrary.simpleMessage(
      "Проверка системного прокси не пройдена: настройки отличаются от запрошенных или недоступны для чтения. Проверьте, не меняет ли их другая программа.",
    ),
    "desktopProxySystemWriteFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось сохранить настройки системного прокси. Проверьте системные ограничения или экспортируйте журналы.",
    ),
    ...
    "hongKongNodesUnavailable": MessageLookupByLibrary.simpleMessage(
      "Нет доступных узлов в Гонконге. Переключение не выполнено.",
    ),
    "hongKongSelectionFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось переключить узел. Повторите попытку или проверьте журнал.",
    ),
    ...
    "inviteCodeDescription": MessageLookupByLibrary.simpleMessage(
      "Поделитесь ссылкой-приглашением: после регистрации друга и покупки тарифа вы получите комиссию.",
    ),
    ...
    "inviteLinkCopyFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось скопировать ссылку-приглашение. Повторите попытку позже.",
    ),
    ...
    "loginIpBlockedStatus": MessageLookupByLibrary.simpleMessage(
      "Заблокирован",
    ),
    "loginIpCount": MessageLookupByLibrary.simpleMessage("IP в истории"),
    "loginIpDescription": MessageLookupByLibrary.simpleMessage(
      "Просматривайте источники входа и управляйте подозрительными IP-адресами.",
    ),
    ...
    "loginIpUnblocked": MessageLookupByLibrary.simpleMessage(
      "IP входа разблокирован",
    ),
    ...
    "networkDiagnosticMode": MessageLookupByLibrary.simpleMessage(
      "Режим прокси",
    ),
    ...
    "networkDiagnosticSelectionNote": MessageLookupByLibrary.simpleMessage(
      "Указан узел, выбранный на момент начала диагностики. В режиме правил YouTube может использовать другой выходной узел.",
    ),
    "networkDiagnosticSuccess": MessageLookupByLibrary.simpleMessage(
      "Локальный прокси и HTTPS-доступ к YouTube работают; воспроизведение видео, длительные соединения и трафик всех приложений/TUN не проверены",
    ),
    ...
    "networkDiagnosticUnknownNode": MessageLookupByLibrary.simpleMessage(
      "Не удалось определить выбранный узел",
    ),
    ...
    "networkDiagnosticYouTubeTlsFailure": MessageLookupByLibrary.simpleMessage(
      "Ошибка TLS-рукопожатия или проверки сертификата",
    ),
    ...
    "noLoginIpRecords": MessageLookupByLibrary.simpleMessage(
      "История IP входа пуста",
    ),
    ...
    "registrationClosed": MessageLookupByLibrary.simpleMessage(
      "Регистрация новых пользователей сейчас закрыта.",
    ),
    ...
    "rememberedLoginClearFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось полностью удалить или отключить сохранённые данные входа. Повторите попытку.",
    ),
    ...
    "softwareUpdate": MessageLookupByLibrary.simpleMessage(
    ...
    "ticketActionFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось выполнить запрос. Введённый текст сохранён. Повторите попытку.",
    ),
    "ticketClose": MessageLookupByLibrary.simpleMessage("Закрыть обращение"),
    "ticketCloseConfirm": MessageLookupByLibrary.simpleMessage(
      "Закрыть обращение? После закрытия ответить будет нельзя.",
    ),
    "ticketClosed": MessageLookupByLibrary.simpleMessage("Закрытые"),
    "ticketContent": MessageLookupByLibrary.simpleMessage("Опишите проблему"),
    "ticketCreated": MessageLookupByLibrary.simpleMessage(
      "Обращение отправлено",
    ),
    "ticketEmpty": MessageLookupByLibrary.simpleMessage("Обращений пока нет"),
    "ticketHigh": MessageLookupByLibrary.simpleMessage("Высокий"),
    "ticketList": MessageLookupByLibrary.simpleMessage("Обращения"),
    "ticketLoadFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось загрузить обращения. Повторите попытку.",
    ),
    "ticketLow": MessageLookupByLibrary.simpleMessage("Низкий"),
    "ticketMore": MessageLookupByLibrary.simpleMessage("Загрузить ещё"),
    "ticketNew": MessageLookupByLibrary.simpleMessage("Новое обращение"),
    "ticketNormal": MessageLookupByLibrary.simpleMessage("Обычный"),
    "ticketOpen": MessageLookupByLibrary.simpleMessage("Открытые"),
    "ticketPriority": MessageLookupByLibrary.simpleMessage("Приоритет"),
    "ticketReadFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось синхронизировать прочтение. Повторите попытку.",
    ),
    "ticketRefresh": MessageLookupByLibrary.simpleMessage("Обновить"),
    "ticketReplied": MessageLookupByLibrary.simpleMessage("Есть ответ"),
    "ticketReply": MessageLookupByLibrary.simpleMessage("Ответить"),
    "ticketReplyHint": MessageLookupByLibrary.simpleMessage("Введите ответ"),
    "ticketRequired": MessageLookupByLibrary.simpleMessage(
      "Заполните это поле",
    ),
    "ticketSubject": MessageLookupByLibrary.simpleMessage("Тема"),
    "ticketSubmit": MessageLookupByLibrary.simpleMessage("Отправить обращение"),
    "ticketSupport": MessageLookupByLibrary.simpleMessage("Поддержка"),
    "ticketUnread": MessageLookupByLibrary.simpleMessage("Непрочитанный ответ"),
    "ticketWaiting": MessageLookupByLibrary.simpleMessage("Ожидает ответа"),
    "ticketYou": MessageLookupByLibrary.simpleMessage("Вы"),
    ...
    "unknownClient": MessageLookupByLibrary.simpleMessage("Неизвестный клиент"),
    "unknownLocation": MessageLookupByLibrary.simpleMessage(
      "Неизвестный регион",
    ),
