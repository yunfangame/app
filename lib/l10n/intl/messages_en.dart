...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(port) => "Current port: ${port}";

  static String m16(code) => "Error code: ${code}";
  ...
  static String m19(count) => "Saved entries: ${count}";

  static String m20(label) => "${label} cannot be empty";

  static String m21(count) => "${count} entries";

  static String m22(label) => "Current ${label} already exists";

  static String m23(date) => "First sign-in: ${date}";

  static String m24(name) => "${name} is already up to date";

  static String m25(name) => "${name} updated";

  static String m26(name) => "Updating ${name}...";
  ...
  static String m30(proxyName) => "${proxyName} is an invalid proxy";
  ...
  static String m37(index) => "Endpoint ${index}";

  static String m38(reason) => "Reason: ${reason}";

  static String m39(count) => "${count} logins";
  ...
  static String m42(reachable, total) => "${reachable}/${total} resolvable";

  static String m43(address) => "${address} is listening";

  static String m44(address) => "Cannot connect to ${address}";

  static String m45(code, stage, error) => "${code} / ${stage}${error}";

  static String m46(address) => "Readback verified ${address}";

  static String m47(status) => "Access check failed · HTTP ${status}";

  static String m48(milliseconds, status) =>
      "Reachable · HTTPS latency ${milliseconds} ms · HTTP ${status}";

  static String m49(date) => "Next plan reset: ${date}";

  static String m50(count) => "${count} nodes";

  static String m51(label) => "No ${label} yet";

  static String m52(label) => "${label} must be a number";

  static String m53(current, total) => "Page ${current} of ${total}";
