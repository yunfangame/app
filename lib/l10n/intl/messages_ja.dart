...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(version) => "新しいバージョン ${version} があります";

  static String m6(version) => "現在のバージョン ${version}";

  static String m7(version) => "${version} は最新バージョンです";

  static String m8(received, total) => "${received} / ${total}";

  static String m9(current, latest) => "現在 ${current}  →  最新 ${latest}";

  static String m10(index) => "ルート ${index}";

  static String m11(count) => "全 ${count} の国と地域";
  ...
  static String m15(port) => "現在のポート：${port}";

  static String m16(code) => "エラーコード：${code}";

  static String m17(label) => "${label}詳細";

  static String m18(entry) =>
      "フィルターの形式が無効です：${entry}。ドメイン、ラベル全体のワイルドカード、geosite:名前 または rule-set:名前 を入力し、URL や空白は含めないでください。";

  static String m19(count) => "保存済み：${count} 件";

  static String m20(label) => "${label}は空欄にできません";

  static String m21(count) => "${count} エントリ";

  static String m22(label) => "現在の${label}は既に存在しています";

  static String m23(date) => "初回ログイン：${date}";

  static String m24(name) => "${name} はすでに最新です";

  static String m25(name) => "${name} 更新済み";

  static String m26(name) => "${name}を更新中...";
  ...
  static String m30(proxyName) => "${proxyName} は無効なプロキシです";

  static String m31(providerName) => "${providerName} は無効なプロキシプロバイダーです";

  static String m32(subRule) => "${subRule} は無効なSUB_RULEです";

  static String m33(date) => "最終ログイン：${date}";

  static String m34(port, code) =>
      "ローカルプロキシを起動できませんでした（${code}、ポート ${port}）。切断しました。診断用ログをエクスポートしてください。";

  static String m35(count) => "${count} 件の接続";
  ...
  static String m37(index) => "接続先${index}";

  static String m38(reason) => "理由：${reason}";

  static String m39(count) => "ログイン ${count} 回";

  static String m40(count) => "${count}分前";

  static String m41(count) => "${count}ヶ月前";

  static String m42(reachable, total) => "${reachable}/${total} を解決可能";

  static String m43(address) => "${address} は待受中です";

  static String m44(address) => "${address} に接続できません";

  static String m45(code, stage, error) => "${code} / ${stage}${error}";

  static String m46(address) => "${address} を読み戻して確認しました";

  static String m47(status) => "接続確認に失敗 · HTTP ${status}";

  static String m48(milliseconds, status) =>
      "接続可能 · HTTPS 遅延 ${milliseconds} ms · HTTP ${status}";

  static String m49(date) => "次回のプランリセット：${date}";

  static String m50(count) => "全 ${count} ノード";

  static String m51(label) => "まだ${label}はありません";

  static String m52(label) => "${label}は数字でなければなりません";

  static String m53(current, total) => "${current} / ${total} ページ";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "allRemainingTraffic": MessageLookupByLibrary.simpleMessage("その他すべての通信"),
    ...
    "appUpdateChecking": MessageLookupByLibrary.simpleMessage("更新を確認中…"),
    "appUpdateChecksumMismatch": MessageLookupByLibrary.simpleMessage(
      "ダウンロードしたファイルの検証に失敗しました。もう一度ダウンロードしてください。",
    ),
    "appUpdateChecksumMissing": MessageLookupByLibrary.simpleMessage(
      "更新の検証情報がないため、ダウンロードできません。サポートにお問い合わせください。",
    ),
    "appUpdateCurrentVersion": m6,
    "appUpdateDownload": MessageLookupByLibrary.simpleMessage("更新をダウンロード"),
    ...
    "blockLoginIp": MessageLookupByLibrary.simpleMessage("ブロック"),
    "blockLoginIpTitle": MessageLookupByLibrary.simpleMessage(
      "このログイン IP をブロックしますか？",
    ),
    "blockLoginIpWarning": MessageLookupByLibrary.simpleMessage(
      "この IP からは今後ログインできなくなりますが、現在のセッションは切断されません。共有ネットワークでは自分の他の端末にも影響する場合があります。",
    ),
    "blockReasonHint": MessageLookupByLibrary.simpleMessage("例：自分のログインではない"),
    "blockReasonOptional": MessageLookupByLibrary.simpleMessage("理由（任意）"),
    "blockedIpCount": MessageLookupByLibrary.simpleMessage("ブロック済み"),
    ...
    "confirmBlockLoginIp": MessageLookupByLibrary.simpleMessage("ブロックする"),
    ...
    "confirmUnblockLoginIp": MessageLookupByLibrary.simpleMessage("制限を解除"),
    ...
    "desktopProxyAddressInUse": MessageLookupByLibrary.simpleMessage(
      "待ち受けポートは別のプログラムに使用されています。そのプログラムを終了して再試行するか、別のポートを選択してください。",
    ),
    "desktopProxyAddressNotAvailable": MessageLookupByLibrary.simpleMessage(
      "設定された待ち受けアドレスはこのコンピューターで利用できません。ネットワーク接続とバインドアドレスを確認して再試行してください。",
    ),
    "desktopProxyChangePort": MessageLookupByLibrary.simpleMessage("ポートを変更"),
    "desktopProxyConfigurationFailed": MessageLookupByLibrary.simpleMessage(
      "プロキシ設定を適用できませんでした。現在の購読と設定を確認するか、ログをエクスポートして原因を調べてください。",
    ),
    ...
    "desktopProxyFailureLogsHint": MessageLookupByLibrary.simpleMessage(
      "ログを表示またはエクスポートし、エラーの詳細をサポートにお送りいただけます。",
    ),
    ...
    "desktopProxyInvalidBindAddress": MessageLookupByLibrary.simpleMessage(
      "待ち受けアドレスの形式が無効です。プロキシ設定のバインドアドレスを確認して再試行してください。",
    ),
    "desktopProxyListenerAccessDenied": MessageLookupByLibrary.simpleMessage(
      "システムが待ち受けポートへのアクセスを拒否しました。予約済みポートやセキュリティポリシーが原因の可能性があります。システムの制限を確認するか、別のポートをお試しください。",
    ),
    "desktopProxyLocalPortUnavailable": MessageLookupByLibrary.simpleMessage(
      "ローカルプロキシポートに接続できませんでした。ポートの競合とはまだ判断できません。再試行するかログをエクスポートしてください。別のポートも試せます。",
    ),
    "desktopProxyPortHint": MessageLookupByLibrary.simpleMessage(
      "1024～49151 の範囲で、他のローカル待ち受けポートと重複しない新しいポートを入力してください。保存後に接続を再試行します。",
    ),
    "desktopProxyPortRange": MessageLookupByLibrary.simpleMessage(
      "1024～49151 の整数のポート番号を入力してください",
    ),
    "desktopProxyPortReserved": MessageLookupByLibrary.simpleMessage(
      "このポートは他のローカル待ち受けサービスに割り当てられています。別のポートを選んでください",
    ),
    ...
    "desktopProxySystemAccessDenied": MessageLookupByLibrary.simpleMessage(
      "システムがプロキシ設定の変更を拒否しました。ユーザー権限や管理ポリシーを確認して再試行してください。",
    ),
    "desktopProxySystemFailed": MessageLookupByLibrary.simpleMessage(
      "システムプロキシの設定が完了しませんでした。再試行し、解決しない場合はログをエクスポートしてください。",
    ),
    ...
    "desktopProxySystemReadbackFailed": MessageLookupByLibrary.simpleMessage(
      "システムプロキシ設定を検証できませんでした。要求した設定と異なるか、読み取れません。別のプログラムがプロキシ設定を変更していないか確認してください。",
    ),
    "desktopProxySystemWriteFailed": MessageLookupByLibrary.simpleMessage(
      "システムプロキシ設定を保存できませんでした。システムの制限を確認するか、診断用ログをエクスポートしてください。",
    ),
    ...
    "dnsAdvancedFakeIpActive": MessageLookupByLibrary.simpleMessage(
      "端末の DNS 設定で Fake-IP を使用しています。以下のフィルターと範囲がこの設定に適用されます。",
    ),
    "dnsAdvancedFakeIpInactive": MessageLookupByLibrary.simpleMessage(
      "現在のモードは Fake-IP ではありません。フィルターと範囲は保存されますが適用されません。使用するには上で fake-ip を選択してください。",
    ),
    "dnsAdvancedFilterDescription": MessageLookupByLibrary.simpleMessage(
      "一致するドメインは Fake-IP ではなく実際の IP アドレスに名前解決されます。これは DIRECT 接続の指定ではありません。直接接続かプロキシ経由かはルーティングルールで決まります。",
    ),
    "dnsAdvancedFilterEditingHint": MessageLookupByLibrary.simpleMessage(
      "1 行につきドメインまたはワイルドカードを 1 つ入力します（例：*.example.com）。行の追加・削除で編集できます。保存時に空行と完全な重複を除去し、既存の高度な項目は保持します。",
    ),
    ...
    "dnsAdvancedLocalFiltersHint": MessageLookupByLibrary.simpleMessage(
      "localhost、*.local、*.lan などのローカルネットワーク用の例外も維持されます。この一覧を空にしても、組み込みの例外は削除されません。",
    ),
    "dnsAdvancedLocalOverrideActive": MessageLookupByLibrary.simpleMessage(
      "DNS の上書きが有効です。端末の DNS 設定がサブスクリプションの設定より優先されます。",
    ),
    "dnsAdvancedLocalOverrideInactive": MessageLookupByLibrary.simpleMessage(
      "DNS の上書きは無効です。通常はサブスクリプションの DNS が優先されますが、ここでの編集内容は端末に保存されます。常にこの設定を使うには上書きを有効にしてください。",
    ),
    "dnsAdvancedLocalSettings": MessageLookupByLibrary.simpleMessage(
      "この端末の DNS 設定です。上書きスイッチとモードの変更は即座に保存されます。フィルターと範囲の変更は「保存」を押すと反映されます。",
    ),
    "dnsAdvancedOptions": MessageLookupByLibrary.simpleMessage("DNS の詳細設定"),
    "dnsAdvancedOptionsDescription": MessageLookupByLibrary.simpleMessage(
      "Fake-IP フィルターと適用条件を確認・編集",
    ),
    "dnsAdvancedRangeDescription": MessageLookupByLibrary.simpleMessage(
      "Fake-IP が使用する仮想 IPv4 アドレスプールです。プロキシやサーバーのアドレスではありません。既定値は 198.18.0.1/16 です。アドレスの競合を避ける必要がある場合のみ変更してください。",
    ),
    "dnsAdvancedRangeInvalid": MessageLookupByLibrary.simpleMessage(
      "198.18.0.1/16 のように、プレフィックスが 0～29 の IPv4 CIDR を入力してください。プールが小さすぎるとコアを起動できません。",
    ),
    ...
    "inviteCodeDescription": MessageLookupByLibrary.simpleMessage(
      "専用リンクを共有し、友達が登録してプランを購入すると報酬を獲得できます。",
    ),
    ...
    "inviteLinkCopyFailed": MessageLookupByLibrary.simpleMessage(
      "招待リンクをコピーできませんでした。しばらくしてからもう一度お試しください。",
    ),
    ...
    "noSavedRules": MessageLookupByLibrary.simpleMessage("保存済みルールはありません"),
    "noSavedRulesDescription": MessageLookupByLibrary.simpleMessage(
      "リアルタイム接続から追加するか、ここで作成できます",
    ),
    ...
    "referenceConnectionDelay": MessageLookupByLibrary.simpleMessage("参考接続遅延"),
    ...
    "rememberedLoginSaveFailed": MessageLookupByLibrary.simpleMessage(
      "ログインしましたが、認証情報を安全に保存できませんでした。次回はパスワードが必要です。",
    ),
    ...
    "ticketActionFailed": MessageLookupByLibrary.simpleMessage(
      "失敗しました。入力内容は保持されています。再試行してください。",
    ),
    "ticketClose": MessageLookupByLibrary.simpleMessage("チケットを終了"),
    "ticketCloseConfirm": MessageLookupByLibrary.simpleMessage(
      "このチケットを終了しますか？終了後は返信できません。",
    ),
    "ticketClosed": MessageLookupByLibrary.simpleMessage("終了"),
    "ticketContent": MessageLookupByLibrary.simpleMessage("問題の内容"),
    "ticketCreated": MessageLookupByLibrary.simpleMessage("送信しました"),
    "ticketEmpty": MessageLookupByLibrary.simpleMessage("チケットはありません"),
    "ticketHigh": MessageLookupByLibrary.simpleMessage("高"),
    "ticketList": MessageLookupByLibrary.simpleMessage("サポートチケット"),
    ...
    "ticketMore": MessageLookupByLibrary.simpleMessage("さらに読み込む"),
    "ticketNew": MessageLookupByLibrary.simpleMessage("チケット作成"),
    "ticketNormal": MessageLookupByLibrary.simpleMessage("中"),
    "ticketOpen": MessageLookupByLibrary.simpleMessage("対応中"),
    "ticketPriority": MessageLookupByLibrary.simpleMessage("優先度"),
    "ticketReadFailed": MessageLookupByLibrary.simpleMessage(
      "既読状態を同期できませんでした。再試行してください。",
    ),
    "ticketRefresh": MessageLookupByLibrary.simpleMessage("更新"),
    "ticketReplied": MessageLookupByLibrary.simpleMessage("返信済み"),
    "ticketReply": MessageLookupByLibrary.simpleMessage("返信"),
    "ticketReplyHint": MessageLookupByLibrary.simpleMessage("返信を入力"),
    "ticketRequired": MessageLookupByLibrary.simpleMessage("入力してください"),
    "ticketSubject": MessageLookupByLibrary.simpleMessage("件名"),
    "ticketSubmit": MessageLookupByLibrary.simpleMessage("送信"),
    "ticketSupport": MessageLookupByLibrary.simpleMessage("サポート"),
    "ticketUnread": MessageLookupByLibrary.simpleMessage("未読の返信"),
    "ticketWaiting": MessageLookupByLibrary.simpleMessage("返信待ち"),
    "ticketYou": MessageLookupByLibrary.simpleMessage("自分"),
    ...
    "tunActivationFailed": MessageLookupByLibrary.simpleMessage(
      "仮想アダプターを起動できませんでした。ログをエクスポートして原因を確認してください。",
    ),
    ...
    "tunStarting": MessageLookupByLibrary.simpleMessage("仮想アダプターを起動中"),
    "tunStartingDescription": MessageLookupByLibrary.simpleMessage(
      "サービスを確認し、仮想アダプターを起動しています。初回は管理者の承認が必要な場合があります。",
    ),
    ...
    "unknownClient": MessageLookupByLibrary.simpleMessage("不明なクライアント"),
    "unknownLocation": MessageLookupByLibrary.simpleMessage("不明な地域"),
    ...
    "viewSavedRules": MessageLookupByLibrary.simpleMessage("保存済みルールを表示"),
