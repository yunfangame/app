...
class AppLocalizations {
  ...
  String get hongKongNodesUnavailable {
    return Intl.message(
      'No Hong Kong nodes are available. No switch was made.',
      name: 'hongKongNodesUnavailable',
      desc: '',
      args: [],
    );
  }
  ...
  String get hongKongSelectionFailed {
    return Intl.message(
      'Unable to switch nodes. Please try again or check the logs.',
  ...
  String get tunStartingDescription {
    return Intl.message(
      'Checking the helper service and starting the virtual adapter. Administrator authorization may be required on first use.',
      name: 'tunStartingDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get tunActivationFailed {
    return Intl.message(
      'The virtual adapter could not start. Export the logs to inspect the checks and connection failure.',
      name: 'tunActivationFailed',
      desc: '',
      args: [],
    );
  }
