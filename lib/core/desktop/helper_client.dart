...
final class HelperClient {
  ...
  HelperClient({
    ...
    p.Context? pathContext,
           ...
           _createDio(
             socketPath:
                 socketPath ?? (Platform.isLinux ? helperSocketPath : null),
           ),
       _paths = pathContext ?? _pathContext,
  ...
  static Dio _createDio({String? socketPath}) {
    return Dio()
  ...
  HelperReadiness _readyFromOk(Response<Object?> response, bool logFailure) {
    ...
    final matches = _paths.equals(helperPath.trim(), _expectedHelperPath());
    if (!matches) {
