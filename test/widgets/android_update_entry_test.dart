...
void main() {
  ...
  testWidgets(
    'Android About keeps product information without a second update entry',
    (tester) async {
    ...
    skip: !system.isDesktop && !system.isAndroid,
    variant: const TargetPlatformVariant({TargetPlatform.android}),
  );

  testWidgets(
    'Android application settings omit the legacy automatic-update switch',
    (tester) async {
      ...
      expect(find.byType(AutoRunItem), findsOneWidget);
