...
select system-proxy fallback. The Windows TUN toggle checks and repairs the helper during activation, with a modal progress
indicator. Remove that indicator before presenting failures; do not add a separate tool button to the home screen.
